...
public class Security
{
    ...
    public override string ToString() { return $"{type,-18} {code,-10} {display_name,14}({name})   start:{start_date}   end:{end_date}"; }
}
...
public class SecurityInfo : Security
{
    ...
    public override string ToString() { return $"{type,-18} {code,-10} {display_name,14}({name}) parent:{parent,-10}   start:{start_date}   end:{end_date}"; }
}
...
public class Bar
{
    ...
    public override string ToString() { return $" {date,-30} O:{open,-10} H:{high,-10} L:{low,-10} C:{close,-10} V:{volume,-10} T:{money,-10}"; }
}
...
//2	2021/10/8 09:00:01.000	22585	22585	22555	604	68133775	83559	22585	20	22565	3	20	224
    ...
    public override string ToString() { return $" {time,-30} C:{current,-10} {b1_p}({b1_v}) -- {a1_p}({a1_v}) H:{high,-10} L:{low,-10} V:{volume,-10} T:{money,-10} P:{position}"; }
}
